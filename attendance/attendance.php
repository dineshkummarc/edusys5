...
<?php
	...
	$sql="select id,first_name,section,roll_no,academic_year,present_class from students where present_class='".$filt_class."' ORDER BY first_name";
	...
	$filt_class=$_GET["filt_class"];
			...
			$sql="select first_name,roll_no,academic_year,present_class from students where present_class='".$filt_class."' ORDER BY first_name";
		$result=mysqli_query($conn,$sql);
		$total_students=mysqli_num_rows($result);
	...
	$sql="select first_name,roll_no,academic_year,present_class from students ORDER BY first_name";
	$result=mysqli_query($conn,$sql);
