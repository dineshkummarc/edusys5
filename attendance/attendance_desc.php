...
function printDiv(income) {
     ...
     document.body.innerHTML = originalContents;
		...
		$sql="select * from attendance where (att_date BETWEEN '$from' and '$to') and first_name='".$first_name."' and roll_no='".$roll_no."' and present_class='".$present_class."'";
		...
		$roll_no=$_GET['roll_no'];
		$present_class=$_GET['present_class'];
		$sql="select * from attendance where first_name='".$first_name."' and roll_no='".$roll_no."' and present_class='".$present_class."'";
