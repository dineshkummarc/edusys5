...
<?php
	...
	$sql="select id,first_name,section,roll_no,academic_year,present_class,father_name from students where present_class='".$filt_class."' and section='".$section."' ORDER BY first_name";
	$result=mysqli_query($conn,$sql);
	...
	<form action="<?php echo 'insert_bulk_software_fee.php?count='.$count;?>" method="post">
	<?php
