...
function printDiv(income) {
     ...
     document.body.innerHTML = originalContents;
		...
		$sql="select * from student_adm_fee where (rec_date BETWEEN '$from' and '$to') and name='".$first_name."' and roll_no='".$roll_no."'";
		...
		$roll_no=$_GET['roll_no'];
		//$present_class=$_GET['present_class'];
		$sql="select * from student_adm_fee where name='".$first_name."' and roll_no='".$roll_no."'";
	...
	if((isset($_GET['from']))&&(isset($_GET['to'])))
		...
		$sql_tot="select sum(adm_fee) as paid_fee_tot from student_adm_fee where (rec_date BETWEEN '$from' and '$to') and name='".$first_name."' and roll_no='".$roll_no."'";
       		
		}
		else
		{
		
		$sql_tot="select sum(adm_fee) as paid_fee_tot from student_adm_fee where name='".$first_name."' and roll_no='".$roll_no."'";
	...
	$sql_fee_tot="select adm_fee  from set_adm_fee where class='".$class."' order by id desc limit 1";
