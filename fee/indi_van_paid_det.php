...
function printDiv(income) {
     ...
     document.body.innerHTML = originalContents;
		...
		$sql="select * from student_van_fee where (rec_date BETWEEN '$from' and '$to') and first_name='".$first_name."' and roll_no='".$roll_no."'";
		...
		$roll_no=$_GET['roll_no'];
		//$present_class=$_GET['present_class'];
		$sql="select * from student_van_fee where first_name='".$first_name."' and roll_no='".$roll_no."'";
	...
	if((isset($_GET['from']))&&(isset($_GET['to'])))
		...
		$sql_tot="select sum(van_fee) as paid_fee_tot from student_van_fee where (rec_date BETWEEN '$from' and '$to') and first_name='".$first_name."' and roll_no='".$roll_no."'";
       		
		}
		else
		{
		
		$sql_tot="select sum(van_fee) as paid_fee_tot from student_van_fee where first_name='".$first_name."' and roll_no='".$roll_no."'";
	...
	$sql_fee_tot="select van_fee  from set_van_fee where route_name='".$route_name."' and stage_name='".$stage_name."' order by id desc limit 1";
