...
function printDiv(income) {
	...
	<?php
		...
		$sql="select id,roll_no,name,class,academic_year,rec_date,sum(adm_fee) as paid_adm_fee from student_fee where class='".$class."' and academic_year='".$academic_year."' and (rec_date BETWEEN '$from' and '$to') group by roll_no ORDER BY name LIMIT $start_from, $num_rec_per_page ";
		...
		$sql="select id,roll_no,name,class,academic_year,rec_date,sum(adm_fee) as paid_adm_fee from student_fee where class='".$class."' and academic_year='".$academic_year."' group by roll_no ORDER BY name LIMIT $start_from, $num_rec_per_page ";
		$sql_set_fee="select id,adm_fee from set_fee where class='".$class."' and academic_year='".$academic_year."' ORDER BY id DESC LIMIT $start_from, $num_rec_per_page ";
		}
...
$today_date=date("Y-m-d");
		...
		$sql="select id,roll_no,name,class,academic_year,rec_date,sum(adm_fee) as paid_adm_fee from student_fee where rec_date='".$today_date."' group by roll_no ORDER BY name LIMIT $start_from, $num_rec_per_page ";
		$result=mysqli_query($conn,$sql);
