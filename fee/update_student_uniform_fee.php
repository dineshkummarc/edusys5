...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql="update student_uniform_fee set name='".$name."',parent_name='".$parent_name."',roll_no='".$roll_no."',academic_year='".$academic_year."',class='".$class."',section='".$section."',tot_fee='".$tot_fee."',adm_fee='".$adm_fee."',tot_paid='".$tot_paid."',rec_date='".$rec_date."',rec_no='".$rec_no."' where id='".$id."'";
