...
<div class="row">
	...
	<div class="col-sm-12">
	   ...
	   <center><h2>All Books</h2></center>
        ...
        <a href="<?php echo 'edit_books.php?id='.$value['id']; ?>">  <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
        <a href="<?php echo 'delete_books.php?id='.$value['id']; ?>">  <i class="fa fa-trash-o fa-lg" style="color:red;" aria-hidden="true"></i></a>
       </div></td>
