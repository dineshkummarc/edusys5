...
<div class="container-fluid">
			  ...
			  <div class="form-group">
					  ...
					  <?php echo '<select class="form-control" name="section">';
						echo '<option value="">Select Section</option>';
							...
							$sql="select distinct section from orph_students";
	...
	$sql="select * from orph_students where present_class='".$filt_class."' and section='".$section."' ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";
	}
	else
	{
		$sql="select * from orph_students where present_class='".$filt_class."' ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";
	}
	...
	$sql="select * from orph_students ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";	
	}
	$result=mysqli_query($conn,$sql);
	$row_count =1;
	...
	?>
        ...
        <a href="<?php echo 'del_confirm.php?name='.$row['first_name'].'&roll='.$row['roll_no']; ?>" title="Delete">  <i class="fa fa-trash-o fa-lg" style="color:red;" aria-hidden="true"></i></a>
       </div></td>
