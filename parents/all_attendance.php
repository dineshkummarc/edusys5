...
function printDiv(income) {
     ...
     document.body.innerHTML = originalContents;
		...
		$sql_tot="select att_date,first_name,roll_no,present_class,sum(att_count)as tot_att_count,present_class from attendance where present_class='".$present_class."' and (att_date BETWEEN '$from' and '$to') group by roll_no";
		...
		$sql_tot_att="select distinct att_date,present_class,sum(tot_class) as tot_class from attendance where present_class='".$present_class."' and (att_date BETWEEN '$from' and '$to')  group by roll_no";
...
<!---------//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////----------->  
	...
	<?php 
	$sql = "SELECT distinct first_name,roll_no,present_class,taken_by,sum(att_count)as tot_att_count FROM attendance group by roll_no"; 
	$sql_tot_att="select distinct att_date,present_class,sum(tot_class) as tot_class from attendance group by roll_no";
		$result_att_tot=mysqli_query($conn,$sql_tot_att);
		if($row=mysqli_fetch_array($result_att_tot,MYSQLI_ASSOC))
	    {
			$tot_class=$row["tot_class"];
