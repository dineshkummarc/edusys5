...
function printDiv(income) {
     ...
     document.body.innerHTML = originalContents;
		...
		*/	
		...
		$sql="select * from assign where class='".$parents_class."' ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";
	...
	{
	$assign_date= date('d-m-Y', strtotime( $row_tot['assign_date'] ));
	

	?>
				<tr>
				<td><?php echo $row_count;?></td>
				<td><?php echo $row_tot["assign_title"];?></td>
