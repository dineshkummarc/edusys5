    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Class Management</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <ul class="nav navbar-right top-nav">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Musthafa</strong>
                                        </h5>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_SESSION['class_uname'];?> <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li>
                        <a href="send_assign.php"><i class="fa fa-fw fa-tasks"></i> Assignments</a>
                    </li>
					<li>
                        <a href="send_noti.php"><i class="fa fa-fw fa-comments"></i> Send Notifications</a>
                    </li>
					<li>
                        <a href="shw_timetable.php"><i class="fa fa-fw fa-calendar"></i> Time Table</a>
                    </li>
