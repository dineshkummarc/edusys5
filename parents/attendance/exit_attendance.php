...
<?php
	...
	$sql="select * from attendance where present_class='".$class."' and attendance='Present' and att_date=	CURDATE() ORDER BY id DESC";
    ...
    <tr>
		...
		<div class="form-group">
		<input type="hidden" name="present_class[]" value="<?php echo $class;?>" class="form-control" readonly>
		</div>
