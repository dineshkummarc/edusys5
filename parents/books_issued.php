	...
	<div class="panel panel-green">
     <div class="panel-heading"><h4>Library Details</h4></div>
      <div class="panel-body">
		...
		<td style="width: 15%; "><span style="font-weight: bold;">Issued Date</span></td>
		
		<td style="width: 15%; "><span style="font-weight: bold;">Returned Date</span></td>
		...
		<?php 
			...
			echo "<a href='books_issued.php?page=1'>".' First '."</a> "; // Goto 1st page  

			for ($i=1; $i<=$total_pages; $i++) { 
						echo "<a href='books_issued.php?page=".$i."'>   ".$i. "   </a> "; 
			}; 
			echo "<a href='books_issued.php?page=$total_pages'>".' Last '."</a> "; // Goto last page
			?>
		</tbody>
