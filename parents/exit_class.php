...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql_contact="select parent_contact,first_name,roll_no from attendance where first_name='".$first_name."' and roll_no='".$roll_no."' and present_class='".$present_class."' and academic_year='".$academic_year."'";
