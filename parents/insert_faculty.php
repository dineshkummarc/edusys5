...
if(isset($_POST["faculty"]))
{
	...
	$sql="insert into faculty (fac_fname,fac_lname,fac_email,fac_dob,parent_contact,fac_desig,class_teach,fac_dep,fac_prev_org,fac_quali,fac_join,fac_add,fac_sex,fac_photo_name,fac_photo_path,fac_photo_type,fac_adhar_name,fac_adhar_path,fac_adhar_type,fac_id_name,fac_id_path,fac_id_type) values('$fac_fname','$fac_lname','$fac_email','$fac_dob','$parent_contact','$fac_desig','$class_teach','$fac_dep','$fac_prev_org','$fac_quali','$fac_join','$fac_add','$fac_sex','$filename','$filepath','$filetype','$filename1','$filepath1','$filetype1','$filename2','$filepath2','$filetype2')";
