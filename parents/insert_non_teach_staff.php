...
if(isset($_POST["non_teach"]))
{
	...
	$sql="insert into non_teach (first_name,last_name,email,dob,contact,desig,join_date,address,sex,photo_name,photo_path,photo_type,adhar_name,adhar_path,adhar_type,id_name,id_path,id_type) values('$first_name','$last_name','$email','$dob','$contact','$desig','$join_date','$add','$sex','$filename','$filepath','$filetype','$filename1','$filepath1','$filetype1','$filename2','$filepath2','$filetype2')";
