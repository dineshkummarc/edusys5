...
<div class="container-fluid">
	...
	$sql="select * from routes where academic_year='".$cur_academic_year."' ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";	
	...
	$sql="select * from routes where academic_year='".$cur_academic_year."'";
	$result=mysqli_query($conn,$sql);
