...
$sql="select * from set_books_fee where id ='".$id."' and academic_year='".$cur_academic_year."'";
...
?>
       <div class="container-fluid">
        ...
        <div class="panel-heading"><h4>Update Books Fee Details</h4></div>
...
<form action="update_setup_books_fee.php" method="post">
