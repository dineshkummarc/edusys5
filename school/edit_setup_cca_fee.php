...
$sql="select * from set_cca_fee where id ='".$id."' and academic_year='".$cur_academic_year."'";
...
?>
       <div class="container-fluid">
        ...
        <div class="panel-heading"><h4>Update Staff Children Fee Details</h4></div>
...
<form action="update_setup_cca_fee.php" method="post">
	  ...
	  <div class="form-group">
	    <label for="usr">Staff Children Fee:</label>
