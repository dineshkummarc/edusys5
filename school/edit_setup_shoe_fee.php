...
$sql="select * from set_shoe_fee where id ='".$id."' and academic_year='".$cur_academic_year."'";
...
?>
       <div class="container-fluid">
        ...
        <div class="panel-heading"><h4>Update Shoe Fee Details</h4></div>
...
<form action="update_setup_shoe_fee.php" method="post">
