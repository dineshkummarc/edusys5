...
$sql="select * from set_software_fee where id ='".$id."' and academic_year='".$cur_academic_year."'";
...
?>
       <div class="container-fluid">
        ...
        <div class="panel-heading"><h4>Update Software Fee Details</h4></div>
...
<form action="update_setup_software_fee.php" method="post">
