...
<?php
	...
	$sql="select * from attendance where academic_year='".$cur_academic_year."' and present_class='".$filt_class."' and attendance='Present' and att_date=	CURDATE() ORDER BY id DESC";
	...
	$sql="select * from attendance where academic_year='".$cur_academic_year."' and present_class='lkg' and att_date=CURDATE() and attendance='Present' ORDER BY id DESC";	
	}
