...
<?php
	...
	$sql="select id,first_name,roll_no from students where academic_year='".$cur_academic_year."' and present_class='".$filt_class."' and section='".$section."' ORDER BY first_name";
