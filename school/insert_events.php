...
if(isset($_POST["events"]))
{
	...
	$sql="insert into events (evt_name,evt_date,evt_time,evt_details,evt_venue,evt_mob,academic_year) values('$evt_name','$evt_date','$evt_time','$evt_details','$evt_venue','$evt_mob','$cur_academic_year')";
