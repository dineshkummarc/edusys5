...
if(isset($_POST["expense"]))
{
	...
	$sql="insert into expense (amount,towards,exp_date,added_by,last_updated,academic_year) values('$amount','$towards','$exp_date','$added_by','$last_updated','$cur_academic_year')";
