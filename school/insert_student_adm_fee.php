...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql="insert into student_adm_fee (name,parent_name,roll_no,academic_year,class,section,tot_fee,adm_fee,tot_paid,rec_date,rec_no) values('$name','$parent_name','$roll_no','$cur_academic_year','$class','$section','$tot_fee','$adm_fee','$tot_paid','$rec_date','$rec_no')";
