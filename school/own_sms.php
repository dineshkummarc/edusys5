...
if(isset($_POST["own_sms"]))
{
	...
	$class = test_input($_POST["filt_class"]);
	...
	//$sql_holiday="select parent_contact from students where academic_year='".$cur_academic_year."' and present_class='".$class."' and section='".$section."'";
	$sql_holiday="select parent_contact from students where academic_year='".$cur_academic_year."' and present_class='".$class."'";
	var_dump($sql_holiday);
	}
