...
$sql="select * from students where academic_year='".$cur_academic_year."' and academic_year='".$cur_academic_year."' and tot_software_paid < tot_software_fee";
$result=mysqli_query($conn,$sql);
//var_dump($sql);
foreach($result as $row){
	$tot_fee=$row["tot_software_fee"];
	$tot_paid=$row["tot_software_paid"];
