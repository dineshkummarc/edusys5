...
$sql="select * from students where academic_year='".$cur_academic_year."' and tot_uniform_paid < tot_uniform_fee";
$result=mysqli_query($conn,$sql);
//var_dump($sql);
foreach($result as $row){
	$tot_fee=$row["tot_uniform_fee"];
	$tot_paid=$row["tot_uniform_paid"];
