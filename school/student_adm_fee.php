...
?>
     ...
     <div class="panel-heading"><h4>Student RTE Fee</h4></div>
      <div class="panel-body">
		...
		if(isset($_GET["failed"]))
				...
				{
					$id=$_GET["id"];
			$sql="select * from student_adm_fee where academic_year='".$cur_academic_year."' and id='".$id."'";
...
<form action="insert_student_adm_fee.php" method="post">
      <div class="form-group">
