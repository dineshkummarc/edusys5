...
?>
     ...
     <div class="panel-heading"><h4>Collect Teachers Children Fee</h4></div>
      <div class="panel-body">
		...
		if(isset($_GET["failed"]))
				...
				{
					$id=$_GET["id"];
			$sql="select * from student_cca_fee where academic_year='".$cur_academic_year."' and id='".$id."'";
            ...
            if($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
				...
				?>
				<h2>Update Teacher Student Fee</h2>
				Name : <?php echo $name_edit;?> , Roll No : <?php echo $roll_no_edit;?> , Class : <?php echo $class_edit;?>			
							
<form action="update_student_cca_fee.php" method="post">
...
-->
	  ...
	  <div class="form-group">
	    <label for="usr">Teachers Children Fee:</label>
...
<form action="insert_student_cca_fee.php" method="post">
      <div class="form-group">
...
-->
	...
	<input type="submit" name="student_fee" class="btn btn-success" value="Collect Teachers Children Fee">
