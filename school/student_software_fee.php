...
?>
     ...
     <div class="panel-heading"><h4>Student Software Fee</h4></div>
      <div class="panel-body">
		...
		if(isset($_GET["failed"]))
	       ...
	       if(isset($_GET['id'])&&($_GET['edit']))
				{
					$id=$_GET["id"];
			$sql="select * from student_software_fee where academic_year='".$cur_academic_year."' and id='".$id."'";
...
<form action="update_student_software_fee.php" method="post">
...
-->
	<div class="form-group">
	    <label for="usr">Software Fee:</label>
...
<form action="insert_student_software_fee.php" method="post">
      <div class="form-group">
