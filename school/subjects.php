...
<div class="row">
	...
	echo "<a href='subjects.php?page=1'>".' First '."</a> "; // Goto 1st page  

	for ($i=1; $i<=$total_pages; $i++) { 
				echo "<a href='subjects.php?page=".$i."'>   ".$i. "   </a> "; 
	}; 
	echo "<a href='subjects.php?page=$total_pages'>".' Last '."</a> "; // Goto last page
	echo '</article></div>
                   </div>';
	 ?>
	</table>
