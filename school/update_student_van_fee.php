...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql_fee="Select van_fee from set_van_fee where academic_year='".$cur_academic_year."' and route_name='".$route_name."'";
  ...
  if($row_fee=mysqli_fetch_array($result_fee,MYSQLI_ASSOC))
	{
		$tot_fee=$row_fee["van_fee"];
		 ...
		 $sql="update student_van_fee set first_name='".$first_name."',roll_no='".$roll_no."',academic_year='".$cur_academic_year."',present_class='".$present_class."',section='".$section."',van_fee='".$van_fee."',rec_date='".$rec_date."',rec_no='".$rec_no."',route_name='".$route_name."' where id='".$id."'";
