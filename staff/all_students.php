...
<div class="container-fluid">
	...
	$sql="select * from students where present_class='".$filt_class."' and section='".$section."' ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";
	}
	else
	{
		$sql="select * from students where present_class='".$filt_class."' ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";
	}
	...
	$sql="select * from students ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";	
	}
	$result=mysqli_query($conn,$sql);
	$row_count =1;
