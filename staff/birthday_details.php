...
{
require("header.php");
$present_class=$_SESSION["staff_class"];
?>
<div id="page-wrapper">
<div class="container-fluid">
	...
	$sql="select id,first_name,roll_no,present_class,class_stream,academic_year,class_join,village,dob,join_date,photo_name,photo_path,photo_type from students where DATE_FORMAT(dob,'%m-%d')='".$today_md."' and present_class='".$present_class."' ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";	
	...
	$sql_count="select id,first_name,roll_no,present_class,class_stream,class_join,village,dob,join_date,photo_name,photo_path,photo_type from students where DATE_FORMAT(dob,'%m-%d')='".$today_md."' and present_class='".$present_class."'";
