        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li>
					 ...
					 <li>
                        ...
                        <ul id="confi" class="collapse">
							...
							<li>
                                <a href="ad_members.php"><i class="fa fa-fw fa-cog"></i> Add Admin</a>
                            </li>
							<li>
					...
					<li>
                        <a target="_blank" href="<?php echo $web;?>/wp-admin"><i class="fa fa-fw fa-dashboard"></i> Website Update</a>
                    </li>
					<!--
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#website"><i class="glyphicon glyphicon-education "></i></i> Website Update <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="website" class="collapse">
                            <li>
                                <a href="page_content.php">Homepage Content</a>
                            </li>
							<li>
                                <a href="gallery_upload.php">Upload Gallery Photos</a>
                            </li>
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#meeting"><i class="fa fa-fw fa-table"></i> Meeting SMS<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="meeting" class="collapse">
                           <li>
                               <a href="send_noti.php"><i class="fa fa-comments-o" aria-hidden="true"></i> Send Meeting SMS</a>
                          </li>
                            <li>
                                <a href="meeting.php">All Meetings</a>
                            </li>
                        </ul>
                    </li>  
					 <li>
