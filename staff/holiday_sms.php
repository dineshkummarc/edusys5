...
if(isset($_POST["holiday_sms"]))
{
	...
	$sql_holiday="select first_name,parent_contact from students";	
	echo "all parents";
	}else{
	$sql_holiday="select first_name,parent_contact from students where present_class='".$meeting_class."' and section='".$section."'";	
