...
if($subject_name!=""){
   $sql="insert into exam_timetable (subject_name,exam_date,exam_name,start_time,end_time,academic_year,present_class,section,assign_date) values('$subject_name','$exam_date','$exam_name','$start_time','$end_time','$academic_year','$present_class','$section','$assign_date')";
