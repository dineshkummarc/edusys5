...
<div class="container-fluid">
  ...
  <div class="row" id="income">
	...
	require("connection.php");
	 $sql_fa1="select * from student_marks where present_class='".$class."' and first_name='".$first_name."' and roll_no='".$roll_no."' and exam_name='fa-1' order by id desc";
	 //var_dump($sql_fa1);
	...
	$sql_fa2="select * from student_marks where present_class='".$class."' and first_name='".$first_name."' and roll_no='".$roll_no."' and exam_name='fa-2' order by id desc";
	...
	$sql_fa3="select * from student_marks where present_class='".$class."' and first_name='".$first_name."' and roll_no='".$roll_no."' and exam_name='fa-3' order by id desc";
	...
	$sql_fa4="select * from student_marks where present_class='".$class."' and first_name='".$first_name."' and roll_no='".$roll_no."' and exam_name='fa-4' order by id desc";
	...
	if($row_fa4=mysqli_fetch_array($result_fa4,MYSQLI_ASSOC))
	{
	 ...
	 $sql_sa1="select * from student_marks where present_class='".$class."' and first_name='".$first_name."' and roll_no='".$roll_no."' and exam_name='sa-1' order by id desc";
	...
	if($row_sa1=mysqli_fetch_array($result_sa1,MYSQLI_ASSOC))
	{
     ...
     $sub12_sa1=$row_sa1["sub12"];
	  ...
	  $sql_sa2="select * from student_marks where present_class='".$class."' and first_name='".$first_name."' and roll_no='".$roll_no."' and exam_name='sa-2' order by id desc";
