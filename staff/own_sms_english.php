...
$meeting_class=$_SESSION["staff_class"];
$section=$_POST["section"];
$message_detail=$_POST["message_detail"];


$sql="select distinct parent_contact,present_class,section from students where present_class='".$meeting_class."' and  section='".$section."'";	
