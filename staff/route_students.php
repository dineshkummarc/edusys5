...
<div class="container-fluid">
  ...
  <div class="row">
	...
	$sql="select * from route_students where route_name='".$route_name."' and stage_name='".$stage_name."' ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";
	}
	...
	$sql="select * from route_students where route_name='".$route_name."' ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";
	}
	...
	$sql="select * from route_students ORDER BY first_name  LIMIT $start_from, $num_rec_per_page";	
	}
	...
	?>
		...
		<td><div class="btn-group"><a href="<?php echo 'description.php?first_name='.$row['first_name'].'&roll_no='.$row['roll_no'];?>" >  <i class="fa fa-eye fa-lg" style="color:#8ba83e;" aria-hidden="true"></i></a>
        <a href="<?php echo 'upd_register.php?id='.$row['id']; ?>">  <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
        <a href="<?php echo 'del_confirm.php?name='.$row['first_name'].'&roll='.$row['roll_no']; ?>">  <i class="fa fa-trash-o fa-lg" style="color:red;" aria-hidden="true"></i></a>
       </div></td>
	...
	$sql="select * from route_students";
	$result=mysqli_query($conn,$sql);
