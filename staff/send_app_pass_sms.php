...
<div class="container">
  <div class="row">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Send Mobile Application Password SMS</div>
...
if($filt_class=="All")
{
	$sql_student="select  parent_contact,first_name,adhaar_no,id from students where academic_year='".$cur_academic_year."'";		
}
else if(($filt_class!="All")&&($filt_class!=""))
{
	$sql_student="select parent_contact,first_name,adhaar_no,id from students where academic_year='".$cur_academic_year."' and present_class='".$filt_class."' and  section='".$section."'";
}
...
foreach($result_student as $row_student){
  ...
  $message="Mobile App login username is ".$first_name.", Password is ".$adhaar_no.". App Download url is ".$app_url.". ".$sms_school_name;

	   $student_id = $row_student["id"];
		 $subject = "Mobile App Credentials SMS";
