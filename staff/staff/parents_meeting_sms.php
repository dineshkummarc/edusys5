...
foreach($result_student as $row_student){
 $student_id = $row_student["id"];
  ...
  $mob_number=$row_student["parent_contact"];
	$message="Dear parent, you are hereby requested to attend our Parent Teachers Meeting on ".$date_time.".It is compulsory to attend the meeting. st.Thomas School";
