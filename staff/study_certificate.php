...
$sql_student = "SELECT * FROM students where first_name='".$first_name."' and roll_no='".$roll_no."'";
	...
	?>
	 ...
	 <span style="text-align:left;">DISE Code : <?php echo $sch_dise;?></span></p>
	  ...
	  <?php 
		...
		?>
		 <center><h3 class="print-color" style="text-decoration:underline;">Study Certificate</h3></center><br>  
		<p style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that Sri/Smt/Kum.<span style="font-weight:bold"><?php echo $first_name;?></span> S/o , D/o,W/o <span style="font-weight:bold"><?php echo $father_name;?></span> belongs to <span style="font-weight:bold"><?php echo $address;?>. He / She has studied in <span style="font-weight:bold"><?php echo $sch_name;?></span> school from <span style="font-weight:bold"><?php echo $from;?></span> to <span style="font-weight:bold"><?php echo $to;?></span> and <span style="font-weight:bold"><?php echo $class_from;?></span> to <span style="font-weight:bold"><?php echo $class_to;?></span> and has passed <span style="font-weight:bold"><?php echo $passed_class;?></span> in the year <span style="font-weight:bold"><?php echo $passed_year;?></span>.</span></p>
		<br>
		<br>
